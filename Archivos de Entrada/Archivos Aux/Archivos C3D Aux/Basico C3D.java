...
void main(){
    ...
    println("El valor defecto de declacion es 0 = ");
  	println(declacion);
    println("El valor defecto de asignacion es 0 ="); 
    print(" y de aritmeticas 0 = ");
  	println(aritmeticas);
    print("Probando ");
    println("Manejo de Entornos");

    if(declacion == 0.0 && asignacion == 0.0 && aritmeticas == 0.0){
        declacion = declacion + 0.50; 
    }else{
        declacion = 0.0;
    }
    println("El valor de var1 global es 10=");  //10
    println(a);
    if(var1==10){
    ...
    int var1 = 5*5;
    println("El valor de var1 local es ");  //25
    println(a);
    if(var1==25){
        declacion = declacion + 0.25; 
    }
    ...
    String String_3 = "false,true,false,true";
    String String_4 = "true,false";
    int int2_;
    boolean TRUE = true;
    boolean FALSE = false;
    int2_ = 45;
