...
void main(){
  ...
  if(1==1){
    ...
    print("El valor de n3 = "); println(n3);
    if (n3 == 70.0) {
      punteo = punteo + 6;
    }
    else {
  ...
  //punteo final
  print("Punteo Final: "); println(punteo);
  int resultado = (punteo*15)/100;
  println("-----------------------------------");
  print("|   RESULTADO ARCHIVO 1 = "); print(resultado); println(" pts  |");
  println("-----------------------------------");
}