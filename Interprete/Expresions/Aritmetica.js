class Aritmetica extends Instruction {
  ...
  compile(generator, env) {
    ...
    if(leftValue.type === Type.STRING && rightValue.type === Type.INT && this.operator == ARITMETIC_OPERATOR.POT){ // String ^ INT64
      generator.fRepeatString();
      return this.repeatString(generator, env, leftValue.value, rightValue.value);
    }
  ...
  repeatString(generator, env, param1, param2) {
    // paso de parámetros
    // Parametro 1
