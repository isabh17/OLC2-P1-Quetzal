class Aritmetica extends Instruction{
  ...
  execute(tree, table){
    ...
    if (this.operator === ARITMETIC_OPERATOR.SUM){
      ...
      ErrorList.addError(new ErrorNode(this.row,this.column,new ErrorType(EnumType.SEMANTIC),`Tipos erroneos en operación resta.`,ENVIRONMENT.NULL));
      ...
      if (this.operLeft.type === Type.INT && this.operRight.type === Type.INT){
        if (this.getVal(this.operRight.type, right) === 0){
          ErrorList.addError(new ErrorNode(this.row,this.column,new ErrorType(EnumType.SEMANTIC),`No es posible dividir entre cero`,ENVIRONMENT.NULL));
      ...
      ErrorList.addError(new ErrorNode(this.row,this.column,new ErrorType(EnumType.SEMANTIC),`Acción erronea en operator unario -.`,ENVIRONMENT.NULL));
