class Relational extends Instruction {
  ...
  compile(generator, env) {
    ...
    if (left.type !== Type.BOOLEAN) {
      ...
      if ((left.type === Type.INT || left.type === Type.DOUBLE) && (right.type === Type.INT || right.type === Type.DOUBLE)) {
        ...
        generator.freeTemp(left.value);
        generator.freeTemp(right.value);
        generator.addIf(this.compareString(generator, env, left.value, right.value), '1', '==', this.trueLbl);
        generator.addGoto(this.falseLbl);
      }
    } else {
      var gotoRight = generator.newLabel();
      var leftTemp = generator.addTemp();
      ...
      var gotoEnd = generator.newLabel();
      var rightTemp = generator.addTemp();
  ...
  compareString(generator, env, param1, param2) {
    // paso de parámetros
    // Parametro 1
