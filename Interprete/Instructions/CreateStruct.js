class CreateStruct extends Instruction {
  ...
  createWithIdOrNull(tree, table){
    ...
    TableReport.addTableSymbol(new NodeTableSymbols(this.row, this.column, String(this.nameObject), String(this.structName), tree.getEnvironment(), value));
    return null;
  }
  ...
  createWithCallFunction(tree, table){
    ...
    //tree.removeEnvironment();
    TableReport.addTableSymbol(new NodeTableSymbols(this.row, this.column, String(this.nameObject), String(this.structName), tree.getEnvironment(), value));
    //TableReport.addTableSymbol(new NodeTableSymbols(this.row, this.column, String(this.nameObject), Type.STRUCT, String(this.structName), value)); 
    return null;
  }
  ...
  normalCreate(tree, table){
    ...
    if(String(this.structName) !== String(this.structName2) ){
      ...
      if(funct.type !== Type.STRUCT){
        ...
        TableReport.addTableSymbol(new NodeTableSymbols(this.row, this.column, String(this.nameObject), String(this.structName), tree.getEnvironment(), value));
        //TableReport.addTableSymbol(new NodeTableSymbols(this.row, this.column, String(this.nameObject), this.type, String(this.structName), value));
        //tree.removeEnvironment();           // Remover ambito cada vez que se termine una ejecucion
        return null;
      }
    }
    ...
    //console.log(this.structName);
    //console.log(this.structName2);
    TableReport.addTableSymbol(new NodeTableSymbols(this.row, this.column, String(this.nameObject), String(this.structName), tree.getEnvironment(), paramsList));
    //TableReport.addTableSymbol(new NodeTableSymbols(this.row, this.column, String(this.nameObject), this.type, String(this.structName), paramsList));
    return null;
  }
